...
public class RaspberryPi implements Connectable {
	...
	public RaspberryPi(String name) {
		this.name = name;
	...
	public void connect(String port, Connectable connectable) {
		...
		System.out.println("    🔗  Connected " + connectable.getClass().getSimpleName() + " " + connectable.getName() + " to RaspberryPi " + name + " on port " + port);
	}
