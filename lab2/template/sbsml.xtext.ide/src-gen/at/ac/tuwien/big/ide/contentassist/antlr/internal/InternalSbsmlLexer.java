...
public class InternalSbsmlLexer extends Lexer {
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:200:12: ( ( '-' )? ( '0' .. '9' )* '.' ( '0' .. '9' )+ ( ( 'E' | 'e' ) ( '-' )? ( '0' .. '9' )+ )? )
            // InternalSbsml.g:200:14: ( '-' )? ( '0' .. '9' )* '.' ( '0' .. '9' )+ ( ( 'E' | 'e' ) ( '-' )? ( '0' .. '9' )+ )?
            {
            // InternalSbsml.g:200:14: ( '-' )?
            int alt1=2;
            ...
            // InternalSbsml.g:200:47: ( ( 'E' | 'e' ) ( '-' )? ( '0' .. '9' )+ )?
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalSbsml.g:200:48: ( 'E' | 'e' ) ( '-' )? ( '0' .. '9' )+
                    {
    ...
    public final void mRULE_BOOL() throws RecognitionException {
        try {
            int _type = RULE_BOOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:202:11: ( ( 'true' | 'false' ) )
            // InternalSbsml.g:202:13: ( 'true' | 'false' )
            {
            // InternalSbsml.g:202:13: ( 'true' | 'false' )
            int alt7=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:204:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalSbsml.g:204:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalSbsml.g:204:11: ( '^' )?
            int alt8=2;
            ...
            // InternalSbsml.g:204:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:206:10: ( ( '0' .. '9' )+ )
            // InternalSbsml.g:206:12: ( '0' .. '9' )+
            {
            // InternalSbsml.g:206:12: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:208:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalSbsml.g:208:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalSbsml.g:208:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalSbsml.g:208:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalSbsml.g:208:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
                    ...
                    break;
                case 2 :
                    // InternalSbsml.g:208:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalSbsml.g:208:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:210:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalSbsml.g:210:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalSbsml.g:210:24: ( options {greedy=false; } : . )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:212:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSbsml.g:212:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalSbsml.g:212:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:214:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalSbsml.g:214:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalSbsml.g:214:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSbsml.g:216:16: ( . )
            // InternalSbsml.g:216:18: .
            {
            matchAny(); 
