...
/**
 * This is the item provider adapter for a {@link sbsml.Actuator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActuatorItemProvider extends ThingItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SbsmlPackage.Literals.ACTUATOR__SERVICES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case SbsmlPackage.ACTUATOR__SERVICES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SbsmlPackage.Literals.ACTUATOR__SERVICES, SbsmlFactory.eINSTANCE.createService()));
	}
