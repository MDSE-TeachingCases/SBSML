...
/**
 * This is the item provider adapter for a {@link sbsml.Unit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitItemProvider extends NamedElementItemProvider {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Unit_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Unit_type_feature", "_UI_Unit_type"),
						SbsmlPackage.Literals.UNIT__TYPE, true, false, false,
	...
	protected void addAbbreviationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Unit_abbreviation_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Unit_abbreviation_feature",
								"_UI_Unit_type"),
						SbsmlPackage.Literals.UNIT__ABBREVIATION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case SbsmlPackage.UNIT__TYPE:
		case SbsmlPackage.UNIT__ABBREVIATION:
