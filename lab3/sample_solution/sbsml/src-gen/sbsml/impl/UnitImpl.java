 ...
 * </p>
 * <ul>
 *   <li>{@link sbsml.impl.UnitImpl#getType <em>Type</em>}</li>
 *   <li>{@link sbsml.impl.UnitImpl#getAbbreviation <em>Abbreviation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitImpl extends NamedElementImpl implements Unit {
	...
	protected EClass eStaticClass() {
		return SbsmlPackage.Literals.UNIT;
	}
	...
	public void setType(DataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SbsmlPackage.UNIT__TYPE, oldType, type));
	}
	...
	public void setAbbreviation(String newAbbreviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SbsmlPackage.UNIT__ABBREVIATION, oldAbbreviation,
					abbreviation));
	}
